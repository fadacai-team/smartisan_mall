...
export default class Evaluate extends Component {
    ...
    tabsChange=(data)=>{
        // console.log(data);
       this.setState({mayLike:data},()=>{
           console.log(this.state.mayLike);
       })
    }
    componentDidUpdate(){
    ...
    render() {
        return (
            <div className={styles.title}>
               ...
               <Tabs item={data} tabsChange={this.tabsChange} tabsActive={1}></Tabs>
               </div>
               <div className={styles.content}>
                ...
                {
                     <MaybeLike key={this.state.mayLike
                    } page={this.state.mayLike+1}></MaybeLike>
                }
              </div>
            </div>
        )
