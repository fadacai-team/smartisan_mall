...
class Preview extends Component {
            ...
            <div className={previewStyle.preview} onClick={
                ...
                <div className={previewStyle.previewData}>
                    <div className={previewStyle.previewDataLeft}>
                        <h2 className={previewStyle.titleLeft}>用户评价（415）</h2>
                    </div>
                ...
                <div className={previewStyle.previewContent}>
                    <div className={previewStyle.userInfo}>
                        ...
                        <span className={previewStyle.userTel}>159****1017</span>
                        {
                            this.state.list.map((item,index) => index<3?<span key={index} className={previewStyle.itemLight}></span>:<span key={index} className={previewStyle.itemDark}></span>)
                            
                        }
                    </div>
                    <div className={previewStyle.userContent}><p>绝对实力派</p></div>
                </div>
            </div>
        )
    }
    ...
    componentDidMount(){
        this.props.setPreviewData(1222)
    }
}
